...
def print_elements(elements, row_separator="-", column_separator="|"):
    name_width = max(len(element[1]) for element in elements)
    for element in elements:
        print(*[f"{column_separator} {property}" + " " * (name_width - len(str(property)) - (7 if len(str(property)) <= 2 else 0)) for property in element], column_separator)
        print(row_separator * (name_width * len(element)))
...
#     symb_width = 2
#     name_width = max(len(element[1]) for element in elements)
#     mass_width = max(len(str(element[2])) for element in elements)
#     for element in elements:
#         for property in element:
#             print(f"{column_separator} {property}", end=" " * (name_width - len(str(property))-(7 if len(str(property))<=2 else 0)))          
